...
$qry = "SELECT COUNT(id) as num, 'Total' as type FROM `coin_portal`.`gadgetdefinition`
UNION
SELECT COUNT(id) as num, 'SSO and Group Enabled' as type FROM `coin_portal`.`gadgetdefinition` where UPPER(supports_groups) = 'T' AND UPPER(supportssso) = 'T' 
UNION 
SELECT COUNT(id) as num, 'SSO Enabled' as type FROM `coin_portal`.`gadgetdefinition` where UPPER(supportssso) = 'T'
UNION
SELECT COUNT(id) as num, 'Group Enabled' as type FROM `coin_portal`.`gadgetdefinition` where UPPER(supports_groups) = 'T'";
